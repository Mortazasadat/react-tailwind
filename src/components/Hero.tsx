  ...
  return (
    <div className="bg-white dark:bg-black">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav
          aria-label="Global"
          className="flex  border-b border-gray-50 items-center justify-between p-6 lg:px-8"
        >
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            ...
            className="relative dark:hidden left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          />
        </div>
        <div className="mx-auto max-w-2xl  py-32 sm:py-48 lg:py-48 ">
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-lg dark:text-white leading-8 text-gray-600">
              Free to use UI components for creative developer
            </p>
        ...
        >
          <div
            ...
            className="relative dark:hidden left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          />
        </div>
      </div>
    </div>
