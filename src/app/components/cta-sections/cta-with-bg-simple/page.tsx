export default function CtaWithBgSimple() {
  return (
      ...
      <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="max-w-xl mx-auto mt-6 text-lg leading-8 text-gray-300">
            ...
            debitis cumque? Necessitatibus natus ea doloremque
          </p>
          <div className="flex items-center justify-center mt-10 gap-x-6">
            ...
            <a
              href="#"
              className="text-sm font-semibold leading-6 text-white to-blue-500"
            >
