...
export default function HeroWithMultiImage() {
  return (
    <div className="min-h-screen bg-black ">
      <main>
        <div className="relative isolate">
          <svg
            className="absolute inset-x-0 top-0 -z-10 h-[60rem] w-full stroke-gray-600 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
            aria-hidden="true"
          >
            <defs>
              <pattern
          ...
          >
            <div
              className="aspect-[801/936] w-[50.0625rem] bg-gradient-to-tr from-blue-500 to-red-400 opacity-30"
              style={{
                clipPath:
            ...
            <div className="px-6 pb-32 mx-auto max-w-7xl pt-36 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="max-w-2xl mx-auto gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  >
                    We’re here to connect the people with AI
                  </motion.h1>
                  <motion.p
                    initial={{ opacity: 0, x: -100 }}
                    animate={{
                    ...
                    transition={{ duration: 1 }}
                    className="relative mt-6 text-lg leading-8 text-gray-300 sm:max-w-md lg:max-w-none"
                  >
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    Tempore maxime dolore nulla omnis autem distinctio beatae in
                    laboriosam quia odit incidunt aut, modi accusamus,
                    praesentium officia eum sit! Consectetur, deserunt.
                  </motion.p>
                  <motion.div
                    ...
                    transition={{ duration: 1 }}
                    className="flex items-center mt-10 gap-x-6"
                  >
                    <a
                      href="#"
